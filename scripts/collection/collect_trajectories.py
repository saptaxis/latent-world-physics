...
def _collect_episodes(
    ...
    # Peel through VecNormalize, VecFrameStack, VecTransposeImage, etc.
    inner = vec_env
...
def main():
    ...
    for agent_dir in agent_dirs:
        ...
        for prof_name, batch_env_fn in eval_batches:
            ...
            if existing and not args.force:
                ...
                print(f"  Use --force to overwrite, or run_eval_pipeline.py --skip-collect to reuse them.")
                continue
    ...
    if len(all_summaries) > 1:
        ...
        for s in all_summaries:
            print(f"{s['agent']:<40s} {s['profile']:<10s} "
